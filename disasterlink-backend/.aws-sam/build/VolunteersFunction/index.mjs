...
function hasOwn(o4, k6) {
  return Object.prototype.hasOwnProperty.call(o4, k6);
}
...
var init_parseJsonBody = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/protocols/json/parseJsonBody.js"() {
    ...
    init_jsonReviver();
    init_needsReviver();
    findKey = (object, key) => Object.keys(object).find((k6) => k6.toLowerCase() === key.toLowerCase());
...
var init_httpAuthSchemeProvider3 = __esm({
  "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/auth/httpAuthSchemeProvider.js"() {
    ...
    createEndpointRuleSetHttpAuthSchemeProvider = (defaultEndpointResolver6, defaultHttpAuthSchemeResolver, createHttpAuthOptionFunctions) => {
...
var _mw0 = (Command2, cs, config, o4) => [];
...
var UpdateItemCommand = class extends command(_ep2, _mw0, "UpdateItem", UpdateItem$) {
};
...
var queryByIndex = async (indexName, keyCondition, expressionValues) => {
  const command6 = new QueryCommand2({
    TableName: TABLE_NAME,
    IndexName: indexName,
    KeyConditionExpression: keyCondition,
    ExpressionAttributeValues: expressionValues
  });
  const response2 = await docClient.send(command6);
  return response2.Items || [];
};
var updateItem = async (pk, sk, updateExpression, expressionValues, expressionNames = {}) => {
  const command6 = new UpdateCommand({
    TableName: TABLE_NAME,
    Key: { PK: pk, SK: sk },
  ...
  const response2 = await docClient.send(command6);
  return response2.Attributes;
};

// handlers/volunteers/index.js
