...
var init_MiddlewareStack = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/client/middleware-stack/MiddlewareStack.js"() {
    ...
    constructStack = () => {
      ...
      const sort = (entries) => entries.sort((a7, b7) => stepWeights[b7.step] - stepWeights[a7.step] || priorityWeights[b7.priority || "normal"] - priorityWeights[a7.priority || "normal"]);
...
function hasOwn(o4, k7) {
  return Object.prototype.hasOwnProperty.call(o4, k7);
}
      ...
      send(command7, optionsOrCb, cb) {
        ...
        if (useHandlerCache) {
          ...
          if (handlers.has(command7.constructor)) {
            handler2 = handlers.get(command7.constructor);
          } else {
            handler2 = command7.resolveMiddleware(this.middlewareStack, this.config, options);
            handlers.set(command7.constructor, handler2);
          }
        } else {
        ...
        if (callback) {
          handler2(command7).then((result) => callback(null, result.output), (err2) => callback(err2)).catch(() => {
          });
        } else {
          return handler2(command7).then((result) => result.output);
        }
      }
      destroy() {
...
var init_schemaDeserializationMiddleware = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/schema/middleware/schemaDeserializationMiddleware.js"() {
    ...
    schemaDeserializationMiddleware = (config) => (next, context) => async (args) => {
      ...
      const [, ns, n4, t2, i7, o4] = operationSchema ?? [];
      try {
        const parsed = await config.protocol.deserializeResponse(operation(ns, n4, t2, i7, o4), {
          ...config,
          ...context
        }, response2);
        return {
        ...
        if (!("$metadata" in error)) {
          ...
          try {
            if (HttpResponse.isInstance(response2)) {
              const { headers = {}, statusCode } = response2;
...
var init_schemaSerializationMiddleware = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/schema/middleware/schemaSerializationMiddleware.js"() {
    ...
    schemaSerializationMiddleware = (config) => (next, context) => async (args) => {
      ...
      const request = await config.protocol.serializeRequest(operation(ns, n4, t2, i7, o4), args.input, {
        ...config,
        ...context,
        endpoint
      });
  ...
  "../node_modules/@smithy/core/dist-es/submodules/schema/schemas/NormalizedSchema.js"() {
    ...
    NormalizedSchema = class _NormalizedSchema {
      ...
      getMemberSchemas() {
        const buffer = {};
        try {
          for (const [k7, v2] of this.structIterator()) {
            buffer[k7] = v2;
          }
        } catch (ignored) {
        }
      ...
      *structIterator() {
        ...
        it = Array(z2);
        for (let i7 = 0; i7 < z2; ++i7) {
          const k7 = struct[4][i7];
          const v2 = member([struct[5][i7], 0], k7);
          yield it[i7] = [k7, v2];
        }
        struct[anno.it] = it;
      }
  ...
  "../node_modules/@smithy/core/dist-es/submodules/schema/TypeRegistry.js"() {
    TypeRegistry = class _TypeRegistry {
      ...
      copyFrom(other) {
        ...
        for (const [k7, v2] of other.schemas) {
          if (!schemas.has(k7)) {
            schemas.set(k7, v2);
          }
        }
        for (const [k7, v2] of other.exceptions) {
          if (!exceptions.has(k7)) {
            exceptions.set(k7, v2);
          }
        }
      }
      register(shapeId, schema) {
        const qualifiedName = this.normalizeShapeId(shapeId);
        for (const r7 of [this, _TypeRegistry.for(qualifiedName.split("#")[0])]) {
          r7.schemas.set(qualifiedName, schema);
        }
      }
      getSchema(shapeId) {
      ...
      registerError(es, ctor) {
        const $error = es;
        const ns = $error[1];
        for (const r7 of [this, _TypeRegistry.for(ns)]) {
          r7.schemas.set(ns + "#" + $error[2], $error);
          r7.exceptions.set($error, ctor);
        }
      }
      getErrorCtor(es) {
        const $error = es;
...
var init_create_aggregated_client = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/client/smithy-client/create-aggregated-client.js"() {
    createAggregatedClient = (commands5, Client2, options) => {
      for (const [command7, CommandCtor] of Object.entries(commands5)) {
        const methodImpl = async function(args, optionsOrCb, cb) {
          const command8 = new CommandCtor(args);
          if (typeof optionsOrCb === "function") {
            this.send(command8, optionsOrCb);
          } else if (typeof cb === "function") {
            if (typeof optionsOrCb !== "object")
              throw new Error(`Expected http options but got ${typeof optionsOrCb}`);
            this.send(command8, optionsOrCb || {}, cb);
          } else {
            return this.send(command8, optionsOrCb);
          }
        };
        const methodName = (command7[0].toLowerCase() + command7.slice(1)).replace(/Command$/, "");
...
var init_exceptions = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/client/smithy-client/exceptions.js"() {
    ...
    decorateServiceException = (exception, additions = {}) => {
      Object.entries(additions).filter(([, v2]) => v2 !== void 0).forEach(([k7, v2]) => {
...
var init_BinaryDecisionDiagram = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/endpoints/util-endpoints/bdd/BinaryDecisionDiagram.js"() {
    BinaryDecisionDiagram = class _BinaryDecisionDiagram {
      ...
      conditions;
      results;
      constructor(bdd7, root7, conditions, results) {
        this.nodes = bdd7;
        this.root = root7;
        this.conditions = conditions;
        this.results = results;
      }
      static from(bdd7, root7, conditions, results) {
        return new _BinaryDecisionDiagram(bdd7, root7, conditions, results);
      }
    };
  }
});
...
var init_uriEncode = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/endpoints/util-endpoints/lib/uriEncode.js"() {
    uriEncode = (value) => encodeURIComponent(value).replace(/[!*'()]/g, (c7) => `%${c7.charCodeAt(0).toString(16).toUpperCase()}`);
  }
});
...
var init_evaluateExpression = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/endpoints/util-endpoints/utils/evaluateExpression.js"() {
    ...
    callFunction = ({ fn, argv }, options) => {
      ...
      for (let i7 = 0; i7 < evaluatedArgs.length; ++i7) {
        const arg = argv[i7];
        if (typeof arg === "boolean" || typeof arg === "number") {
          evaluatedArgs[i7] = arg;
        } else {
          evaluatedArgs[i7] = group.evaluateExpression(arg, "arg", options);
        }
      }
...
var init_decideEndpoint = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/endpoints/util-endpoints/decideEndpoint.js"() {
    ...
    init_getEndpointUrl();
    RESULT = 1e8;
    decideEndpoint = (bdd7, options) => {
      const { nodes: nodes7, root: root7, results, conditions } = bdd7;
      let ref = root7;
      ...
      while (ref !== 1 && ref !== -1 && ref < RESULT) {
        ...
        const [condition_i, highRef, lowRef] = [nodes7[node_i], nodes7[node_i + 1], nodes7[node_i + 2]];
...
var init_constants_for_browser = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/serde/util-base64/constants-for-browser.js"() {
    ...
    alphabetByEncoding = Object.entries(chars).reduce((acc, [i7, c7]) => {
      acc[c7] = Number(i7);
      return acc;
    }, {});
...
function toBase642(_input) {
  ...
  let str = "";
  for (let i7 = 0; i7 < input.length; i7 += 3) {
    let bits = 0;
    let bitLength = 0;
    for (let j7 = i7, limit = Math.min(i7 + 3, input.length); j7 < limit; j7++) {
      bits |= input[j7] << (limit - j7 - 1) * bitsPerByte;
      bitLength += bitsPerByte;
    }
    const bitClusterCount = Math.ceil(bitLength / bitsPerLetter);
    bits <<= bitClusterCount * bitsPerLetter - bitLength;
    for (let k7 = 1; k7 <= bitClusterCount; k7++) {
      const offset = (bitClusterCount - k7) * bitsPerLetter;
    ...
    Crc32Js = class {
      ...
      update(data) {
        for (let i7 = 0; i7 < data.length; ++i7) {
          this.checksum = this.checksum >>> 8 ^ CRC32_TABLE[(this.checksum ^ data[i7]) & 255];
        }
      }
      digestSync() {
    ...
    Sha256Js = class _Sha256Js {
      ...
      digestSync() {
        ...
        if ((bufferLength - 1) % BLOCK >= BLOCK - 8) {
          for (let i7 = bufferLength; i7 < BLOCK; ++i7) {
            bufferView.setUint8(i7, 0);
          }
          this.hashBufferWith(state2, buffer);
          bufferLength = 0;
        }
        for (let i7 = bufferLength; i7 < BLOCK - 8; ++i7) {
          bufferView.setUint8(i7, 0);
        }
        ...
        for (let i7 = 0; i7 < 8; ++i7) {
          out[i7 * 4] = state2[i7] >>> 24 & 255;
          out[i7 * 4 + 1] = state2[i7] >>> 16 & 255;
          out[i7 * 4 + 2] = state2[i7] >>> 8 & 255;
          out[i7 * 4 + 3] = state2[i7] >>> 0 & 255;
        }
        return out;
      }
      static normalizeKey(secret) {
        ...
        if (key.byteLength > BLOCK) {
          const h7 = new _Sha256Js();
          h7.update(key);
          const out = h7.digestSync();
      ...
      hashBufferWith(state2, buffer) {
        ...
        for (let i7 = 0; i7 < BLOCK; ++i7) {
          if (i7 < 16) {
            w2[i7] = (buffer[i7 * 4] & 255) << 24 | (buffer[i7 * 4 + 1] & 255) << 16 | (buffer[i7 * 4 + 2] & 255) << 8 | buffer[i7 * 4 + 3] & 255;
          } else {
            let u2 = w2[i7 - 2];
            const t12 = (u2 >>> 17 | u2 << 15) ^ (u2 >>> 19 | u2 << 13) ^ u2 >>> 10;
            u2 = w2[i7 - 15];
            const t22 = (u2 >>> 7 | u2 << 25) ^ (u2 >>> 18 | u2 << 14) ^ u2 >>> 3;
            w2[i7] = (t12 + w2[i7 - 7] | 0) + (t22 + w2[i7 - 16] | 0);
          }
          const t1 = (((s4 >>> 6 | s4 << 26) ^ (s4 >>> 11 | s4 << 21) ^ (s4 >>> 25 | s4 << 7)) + (s4 & s5 ^ ~s4 & s6) | 0) + (s7 + (K[i7] + w2[i7] | 0) | 0) | 0;
...
var init_EventStreamSerde = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/event-streams/EventStreamSerde.js"() {
    ...
    EventStreamSerde = class {
      ...
      async deserializeEventStream({ response: response2, responseSchema, initialResponseContainer, initialMessageType }) {
        const marshaller = this.marshaller;
    ...
    HttpProtocol = class extends SerdeContext {
      ...
      updateServiceEndpoint(request, endpoint) {
        if ("url" in endpoint) {
          ...
          for (const [k7, v2] of endpoint.url.searchParams.entries()) {
            request.query[k7] = v2;
          }
          if (endpoint.headers) {
            for (const name in endpoint.headers) {
    ...
    HttpBindingProtocol = class extends HttpProtocol {
      ...
      async deserializeResponse(operationSchema, context, response2) {
        ...
        for (const header in response2.headers) {
          if (!hasOwn(response2.headers, header))
            continue;
          ...
          if (memberTraits.httpPayload) {
            ...
            if (isStreaming) {
              ...
              if (isEventStream) {
                ...
                dataObject[memberName] = sdkStreamMixin2(response2.body);
              }
...
function parseRetryAfterHeader(response2, logger2) {
  ...
  for (const header in response2.headers) {
    if (!hasOwn(response2.headers, header))
      continue;
    const h7 = header.toLowerCase();
    if (h7 === "retry-after") {
      const retryAfter = response2.headers[header];
    ...
    } else if (h7 === "x-amz-retry-after") {
      const v2 = response2.headers[header];
    ...
    if (isRetryStrategyV2(retryStrategy)) {
      ...
      while (true) {
        try {
          ...
          const retryErrorInfo = getRetryErrorInfo(e7, options.logger);
  ...
  "../node_modules/@smithy/core/dist-es/submodules/retry/util-retry/DefaultRateLimiter.js"() {
    ...
    DefaultRateLimiter = class _DefaultRateLimiter {
      ...
      updateClientSendingRate(response2) {
        ...
        const retryErrorInfo = response2;
        const isThrottling = retryErrorInfo?.errorType === "THROTTLING" || isThrottlingError(retryErrorInfo?.error ?? response2);
        if (isThrottling) {
...
var init_DefaultRetryBackoffStrategy = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/retry/util-retry/DefaultRetryBackoffStrategy.js"() {
    ...
    DefaultRetryBackoffStrategy = class {
      x = Retry.delay();
      computeNextBackoffDelay(i7) {
        const b7 = Math.random();
        const r7 = 2;
        const t_i = b7 * Math.min(this.x * r7 ** i7, MAXIMUM_RETRY_DELAY);
...
var init_recursionDetectionMiddleware = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/client/middleware-recursion-detection/recursionDetectionMiddleware.js"() {
    ...
    recursionDetectionMiddleware = () => (next) => async (args) => {
      ...
      let invokeStore;
      {
        const traceIdHeader = Object.keys(request.headers ?? {}).find((h7) => h7.toLowerCase() === X_AMZN_TRACE_ID.toLowerCase()) ?? X_AMZN_TRACE_ID;
...
var init_createPaginator = __esm({
  "../node_modules/@smithy/core/dist-es/legacy-root-exports/pagination/createPaginator.js"() {
    makePagedClientRequest = async (CommandCtor, client2, input, withCommand = (_) => _, ...args) => {
      let command7 = new CommandCtor(input);
      command7 = withCommand(command7) ?? command7;
      return await client2.send(command7, ...args);
    };
    get = (fromObject, path) => {
...
var init_getDateHeader = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/utils/getDateHeader.js"() {
    init_protocols();
    getDateHeader = (response2) => HttpResponse.isInstance(response2) ? response2.headers?.date ?? response2.headers?.Date : void 0;
    getAgeHeader = (response2) => HttpResponse.isInstance(response2) ? response2.headers?.age ?? response2.headers?.Age : void 0;
  }
});
...
or increase socketAcquisitionWarningTimeout=(millis) in the NodeHttpHandler config.`);
      ...
      async handle(request, { abortSignal, requestTimeout } = {}) {
        ...
        return new Promise((_resolve, _reject) => {
          ...
          writeRequestBodyPromise = writeRequestBody(req, request, effectiveRequestTimeout, this.externalAgent).catch((e7) => {
            clearTimeouts();
            return _reject(e7);
          });
        });
...
function createGetRequest(url) {
  return new HttpRequest({
    ...
    path: url.pathname,
    query: Array.from(url.searchParams.entries()).reduce((acc, [k7, v2]) => {
      acc[k7] = v2;
      return acc;
    }, {}),
    fragment: url.hash
...
async function getCredentials(response2, logger2) {
  const stream = sdkStreamMixin2(response2.body);
  ...
  if (response2.statusCode >= 400 && response2.statusCode < 500) {
    ...
    throw Object.assign(new CredentialsProviderError(`Server responded with status: ${response2.statusCode}`, { logger: logger2 }), {
      Code: parsedBody.Code,
      Message: parsedBody.Message
    });
  }
  throw new CredentialsProviderError(`Server responded with status: ${response2.statusCode}`, { logger: logger2 });
}
    ...
    ProtocolLib = class {
      ...
      async getErrorSchemaOrThrowBaseException(errorIdentifier, defaultNamespace, response2, dataObject, metadata, getErrorSchema) {
        ...
        try {
          ...
          const d7 = dataObject;
          const message = d7?.message ?? d7?.Message ?? d7?.Error?.Message ?? d7?.Error?.message;
      ...
      setQueryCompatError(output, response2) {
        ...
        if (output !== void 0 && queryErrorHeader != null) {
          ...
          for (let i7 = 0; i7 < keys.length; i7++) {
            const k7 = keys[i7];
            Error2[k7 === "message" ? "Message" : k7] = output[k7];
          }
    ...
    UnionSerde = class {
      ...
      writeUnknown() {
        if (this.hasUnknown()) {
          ...
          const v2 = this.from[k7];
          this.to.$unknown = [k7, v2];
        }
      }
    };
  }
...
var init_parseJsonBody = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/protocols/json/parseJsonBody.js"() {
    ...
    init_jsonReviver();
    init_needsReviver();
    findKey = (object, key) => Object.keys(object).find((k7) => k7.toLowerCase() === key.toLowerCase());
    ...
    JsonShapeDeserializer2 = class extends SerdeContextConfig {
          ...
          if (Array.isArray(value) && ns.isListSchema()) {
            ...
            if (this.needsTransform(listMember)) {
              for (let i7 = 0; i7 < value.length; ++i7) {
                value[i7] = this._read(listMember, value[i7]);
              }
            }
            return value;
          }
          if (ns.isMapSchema()) {
            ...
            if (this.needsTransform(mapMember)) {
              for (const k7 in map) {
                ...
                map[k7] = this._read(mapMember, map[k7]);
              }
            }
            return map;
          }
      ...
      _readStruct(ns, record) {
        ...
        if (union) {
          ...
          for (const k7 in record) {
            const v2 = record[k7];
            const t2 = jsonName ? nameMap[k7] ?? k7 : k7;
            if (!(t2 in out)) {
              out[t2] = v2;
            }
          }
...
var init_JsonShapeSerializer2 = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/protocols/json/codec-v2/JsonShapeSerializer2.js"() {
    ...
    for (let i7 = 0; i7 < 32; i7++) {
      if (ESCAPE_TABLE[i7] === null) {
        ESCAPE_TABLE[i7] = "u00" + i7.toString(16).padStart(2, "0");
      }
    }
    ...
    JsonShapeSerializer2 = class _JsonShapeSerializer2 extends SerdeContextConfig {
      ...
      flush() {
        ...
        const { i: i7, json } = this;
        if (i7 + byteCount > json.length) {
          let newSize = json.length * 2;
          while (newSize < i7 + byteCount) {
            newSize *= 2;
          }
      ...
      writeAscii(s3) {
        ...
        this.ensure(z2);
        let { i: i7, json } = this;
        for (let j7 = 0; j7 < z2; ++j7) {
          json[i7] = s3.charCodeAt(j7);
          i7 += 1;
        }
        this.i = i7;
      }
      ...
      writeJsonString(s3) {
        ...
        const z2 = s3.length;
        for (let j7 = 0; j7 < z2; ++j7) {
          const c7 = s3.charCodeAt(j7);
          if (c7 > 34 && c7 < 92) {
            this.json[this.i++] = c7;
          } else if (c7 < 128) {
            const esc = ESCAPE_TABLE[c7];
            if (esc !== null) {
              this.ensure(esc.length + 1);
              this.json[this.i++] = BACKSLASH;
              for (let k7 = 0; k7 < esc.length; k7++) {
                this.json[this.i++] = esc.charCodeAt(k7);
              }
            } else {
              this.json[this.i++] = c7;
            }
          } else if (c7 >= 55296 && c7 <= 56319) {
            const next = j7 + 1 < z2 ? s3.charCodeAt(j7 + 1) : 0;
            if (next >= 56320 && next <= 57343) {
              this.ensure(4);
              const { written } = encoder.encodeInto(s3.substring(j7, j7 + 2), this.json.subarray(this.i));
              this.i += written;
              ++j7;
            } else {
              this.ensure(6);
              this.writeUnicodeEscape(c7);
            }
          } else if (c7 >= 56320 && c7 <= 57343) {
            this.ensure(6);
            this.writeUnicodeEscape(c7);
          } else {
            let { i: i7, json } = this;
      ...
      writeBase64(data) {
        ...
        for (let j7 = 0; j7 < mainLen; j7 += 3) {
          const a7 = data[j7];
          const b7 = data[j7 + 1];
          const c7 = data[j7 + 2];
          json[i7++] = B64[a7 >> 2];
          json[i7++] = B64[(a7 & 3) << 4 | b7 >> 4];
          json[i7++] = B64[(b7 & 15) << 2 | c7 >> 6];
          json[i7++] = B64[c7 & 63];
        }
        if (remainder === 2) {
          const a7 = data[mainLen];
          const b7 = data[mainLen + 1];
          json[i7++] = B64[a7 >> 2];
          json[i7++] = B64[(a7 & 3) << 4 | b7 >> 4];
          json[i7++] = B64[(b7 & 15) << 2];
          json[i7++] = 61;
      ...
      writeStruct(ns, value) {
        ...
        if (!wroteAny && ns.isUnionSchema()) {
          ...
          if (Array.isArray($unknown)) {
            const [k7, v2] = $unknown;
            this.writeAsciiQuoted(k7);
            this.ensure(1);
            this.json[this.i++] = COLON;
            this.writeValue(15, v2, ns);
          }
        } else if (hasType) {
          for (const k7 in value) {
            if (writtenKeys.has(k7)) {
              continue;
            }
            writtenKeys.add(k7);
            const v2 = value[k7];
...
var init_AwsJsonRpcProtocol = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/protocols/json/AwsJsonRpcProtocol.js"() {
    ...
    AwsJsonRpcProtocol = class extends RpcProtocol {
      ...
      mixin;
      awsQueryCompatible;
      constructor({ defaultNamespace, errorTypeRegistries: errorTypeRegistries7, serviceTarget, awsQueryCompatible, jsonCodec }) {
        super({
          defaultNamespace,
          errorTypeRegistries: errorTypeRegistries7
        });
      ...
      async handleError(operationSchema, context, response2, dataObject, metadata) {
        ...
        const errorIdentifier = loadJsonRpcErrorCode(response2, dataObject, awsQueryCompatible) ?? "Unknown";
        this.mixin.compose(this.compositeErrorRegistry, errorIdentifier, this.options.defaultNamespace);
        const { errorSchema, errorMetadata } = await this.mixin.getErrorSchemaOrThrowBaseException(errorIdentifier, this.options.defaultNamespace, response2, dataObject, metadata, awsQueryCompatible ? this.mixin.findQueryCompatibleError : void 0);
...
var init_AwsRestJsonProtocol = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/protocols/json/AwsRestJsonProtocol.js"() {
    ...
    AwsRestJsonProtocol = class extends HttpBindingProtocol {
      ...
      constructor({ defaultNamespace, errorTypeRegistries: errorTypeRegistries7, jsonCodec }) {
        super({
          defaultNamespace,
          errorTypeRegistries: errorTypeRegistries7
        });
      ...
      parse() {
        ...
        while (p4.i < z2) {
          ...
          if (p4.isNext("<?")) {
            ...
            const root7 = p4.parseTag();
            return { [root7.tag]: root7.value };
          } else {
...
var init_commandBuilder = __esm({
  "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/commandBuilder.js"() {
    ...
    init_endpoints();
    init_EndpointParameters();
    command = makeBuilder(commonParams2, "AWSSSOOIDCService", "SSOOIDCClient", getEndpointPlugin);
    _ep0 = {};
    _mw0 = (Command2, cs, config, o4) => [];
  }
});
...
var init_commandBuilder2 = __esm({
  "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/commandBuilder.js"() {
    ...
    init_endpoints();
    init_EndpointParameters2();
    command2 = makeBuilder(commonParams3, "SWBPortalService", "SSOClient", getEndpointPlugin);
    _ep02 = {};
    _mw02 = (Command2, cs, config, o4) => [];
  }
});
...
var init_httpAuthSchemeProvider3 = __esm({
  "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/auth/httpAuthSchemeProvider.js"() {
    ...
    createEndpointRuleSetHttpAuthSchemeProvider = (defaultEndpointResolver7, defaultHttpAuthSchemeResolver, createHttpAuthOptionFunctions) => {
...
var init_commandBuilder3 = __esm({
  "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commandBuilder.js"() {
    ...
    init_endpoints();
    init_EndpointParameters3();
    command3 = makeBuilder(commonParams4, "AWSSecurityTokenServiceV20110615", "STSClient", getEndpointPlugin);
    _ep03 = {};
    _mw03 = (Command2, cs, config, o4) => [];
  }
});
...
var init_commandBuilder4 = __esm({
  "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/commandBuilder.js"() {
    ...
    init_endpoints();
    init_EndpointParameters4();
    command4 = makeBuilder(commonParams5, "Signin", "SigninClient", getEndpointPlugin);
    _ep04 = {
  ...
  "../node_modules/@aws-sdk/credential-provider-login/dist-es/LoginCredentialsFetcher.js"() {
    ...
    LoginCredentialsFetcher = class _LoginCredentialsFetcher {
      ...
      async refresh(token) {
        ...
        try {
          const response2 = await client2.send(new CreateOAuth2TokenCommand2(commandInput));
...
var init_resolveProcessCredentials2 = __esm({
  "../node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveProcessCredentials.js"() {
    ...
    resolveProcessCredentials2 = async (options, profile) => {
...
var require_iterator = __commonJS({
  "../node_modules/obliterator/iterator.js"(exports, module) {
    ...
    Iterator.of = function() {
      var args = arguments, l5 = args.length, i7 = 0;
...
var require_foreach = __commonJS({
  "../node_modules/obliterator/foreach.js"(exports, module) {
    ...
    function forEach(iterable, callback) {
      var iterator, k7, i7, l5, s3;
      if (!iterable)
        throw new Error("obliterator/forEach: invalid iterable.");
      if (typeof callback !== "function")
        throw new Error("obliterator/forEach: expecting a callback.");
      if (Array.isArray(iterable) || ARRAY_BUFFER_SUPPORT && ArrayBuffer.isView(iterable) || typeof iterable === "string" || iterable.toString() === "[object Arguments]") {
        for (i7 = 0, l5 = iterable.length; i7 < l5; i7++)
...
var require_typed_arrays = __commonJS({
  "../node_modules/mnemonist/utils/typed-arrays.js"(exports) {
    ...
    exports.getMinimalRepresentation = function(array, getter) {
      var maxType = null, maxPriority = 0, p4, t2, v2, i7, l5;
      for (i7 = 0, l5 = array.length; i7 < l5; i7++) {
        v2 = getter ? getter(array[i7]) : array[i7];
    ...
    exports.concat = function() {
      var length = 0, i7, o4, l5;
      for (i7 = 0, l5 = arguments.length; i7 < l5; i7++)
        length += arguments[i7].length;
      var array = new arguments[0].constructor(length);
      for (i7 = 0, o4 = 0; i7 < l5; i7++) {
        array.set(arguments[i7], o4);
        o4 += arguments[i7].length;
      }
      return array;
    };
...
var require_lru_cache = __commonJS({
  "../node_modules/mnemonist/lru-cache.js"(exports, module) {
    ...
    if (typeof Symbol !== "undefined")
      LRUCache2.prototype[/* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom")] = LRUCache2.prototype.inspect;
...
function memoizeChain(providers, treatAsExpired) {
  ...
  const provider = async (options) => {
    if (options?.forceRefresh) {
      if (!forceRefreshLock) {
        forceRefreshLock = chain2(options).then((c7) => {
          credentials = c7;
        }).finally(() => {
...
var _data5 = {
  ...
  results: [
    ...
    [h5, k5],
    ["https://cognito-idp-fips.us-east-1.amazonaws.com", k5],
    ["https://cognito-idp-fips.us-east-2.amazonaws.com", k5],
    ["https://cognito-idp-fips.us-west-1.amazonaws.com", k5],
    ["https://cognito-idp-fips.us-west-2.amazonaws.com", k5],
    ["https://cognito-idp-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", k5],
    [a5, "FIPS and DualStack are enabled, but this partition does not support one or both"],
    ["https://cognito-idp-fips.{Region}.{PartitionResult#dnsSuffix}", k5],
    [a5, "FIPS is enabled but this partition does not support FIPS"],
    ["https://cognito-idp.{Region}.amazonaws.com", k5],
    ["https://cognito-idp.{Region}.{PartitionResult#dualStackDnsSuffix}", k5],
    [a5, "DualStack is enabled but this partition does not support DualStack"],
    ["https://cognito-idp.{Region}.{PartitionResult#dnsSuffix}", k5],
...
var AccessDeniedException3 = class _AccessDeniedException extends CognitoIdentityProviderServiceException {
  name = "AccessDeniedException";
  $fault = "client";
  constructor(opts) {
    super({
...
var ResourceNotFoundException2 = class _ResourceNotFoundException extends CognitoIdentityProviderServiceException {
  name = "ResourceNotFoundException";
  $fault = "client";
  constructor(opts) {
    super({
...
var InternalServerException3 = class _InternalServerException extends CognitoIdentityProviderServiceException {
  name = "InternalServerException";
  $fault = "server";
  constructor(opts) {
    super({
...
var ServiceQuotaExceededException = class _ServiceQuotaExceededException extends CognitoIdentityProviderServiceException {
...
var _ACSU = "AdminConfirmSignUp";
var _ACSUR = "AdminConfirmSignUpRequest";
var _ACSURd = "AdminConfirmSignUpResponse";
...
var _AGUAFRd = "AdminGetUserAuthFactorsResponse";
...
var _CD = "ContextData";
var _CDD = "CodeDeliveryDetails";
var _CDDT = "CodeDeliveryDetailsType";
...
var _ESCT = "EumsSmsConfigurationType";
...
var _GCTR = "GetClientTokenRequest";
...
var _Na = "Name";
var _OI = "OriginationIdentity";
var _ONEE = "OperationNotEnabledException";
var _P2 = "Password";
var _PA2 = "PreAuthentication";
var _PAo = "PostAuthentication";
var _PC2 = "PostConfirmation";
...
var _m4 = "message";
var _rC2 = "reasonCode";
var _s5 = "smithy.ts.sdk.synthetic.com.amazonaws.cognitoidentityprovider";
var _se3 = "server";
var n05 = "com.amazonaws.cognitoidentityprovider";
var _s_registry5 = TypeRegistry.for(_s5);
var CognitoIdentityProviderServiceException$ = [-3, _s5, "CognitoIdentityProviderServiceException", 0, [], []];
_s_registry5.registerError(CognitoIdentityProviderServiceException$, CognitoIdentityProviderServiceException);
...
n0_registry5.registerError(AliasExistsException$, AliasExistsException);
...
n0_registry5.registerError(CodeDeliveryFailureException$, CodeDeliveryFailureException);
...
n0_registry5.registerError(CodeMismatchException$, CodeMismatchException);
...
n0_registry5.registerError(DeviceKeyExistsException$, DeviceKeyExistsException);
...
n0_registry5.registerError(DuplicateProviderException$, DuplicateProviderException);
...
n0_registry5.registerError(EnableSoftwareTokenMFAException$, EnableSoftwareTokenMFAException);
...
n0_registry5.registerError(ExpiredCodeException$, ExpiredCodeException);
...
n0_registry5.registerError(FeatureUnavailableInTierException$, FeatureUnavailableInTierException);
...
n0_registry5.registerError(ForbiddenException$, ForbiddenException);
...
n0_registry5.registerError(GroupExistsException$, GroupExistsException);
...
n0_registry5.registerError(InvalidEmailRoleAccessPolicyException$, InvalidEmailRoleAccessPolicyException);
...
n0_registry5.registerError(InvalidLambdaResponseException$, InvalidLambdaResponseException);
...
n0_registry5.registerError(InvalidOAuthFlowException$, InvalidOAuthFlowException);
...
n0_registry5.registerError(InvalidPasswordException$, InvalidPasswordException);
...
n0_registry5.registerError(InvalidSmsRoleAccessPolicyException$, InvalidSmsRoleAccessPolicyException);
...
n0_registry5.registerError(InvalidSmsRoleTrustRelationshipException$, InvalidSmsRoleTrustRelationshipException);
...
n0_registry5.registerError(InvalidUserPoolConfigurationException$, InvalidUserPoolConfigurationException);
...
n0_registry5.registerError(ManagedLoginBrandingExistsException$, ManagedLoginBrandingExistsException);
...
n0_registry5.registerError(MFAMethodNotFoundException$, MFAMethodNotFoundException);
...
n0_registry5.registerError(OperationNotEnabledException$, OperationNotEnabledException);
...
n0_registry5.registerError(PasswordHistoryPolicyViolationException$, PasswordHistoryPolicyViolationException);
...
n0_registry5.registerError(PasswordResetRequiredException$, PasswordResetRequiredException);
...
n0_registry5.registerError(PreconditionNotMetException$, PreconditionNotMetException);
...
n0_registry5.registerError(RefreshTokenReuseException$, RefreshTokenReuseException);
...
n0_registry5.registerError(ScopeDoesNotExistException$, ScopeDoesNotExistException);
...
n0_registry5.registerError(SoftwareTokenMFANotFoundException$, SoftwareTokenMFANotFoundException);
...
n0_registry5.registerError(TermsExistsException$, TermsExistsException);
...
n0_registry5.registerError(TierChangeNotAllowedException$, TierChangeNotAllowedException);
...
n0_registry5.registerError(TooManyFailedAttemptsException$, TooManyFailedAttemptsException);
...
n0_registry5.registerError(UnauthorizedException$2, UnauthorizedException2);
...
n0_registry5.registerError(UnexpectedLambdaException$, UnexpectedLambdaException);
...
n0_registry5.registerError(UnsupportedIdentityProviderException$, UnsupportedIdentityProviderException);
...
n0_registry5.registerError(UnsupportedOperationException$, UnsupportedOperationException);
...
n0_registry5.registerError(UnsupportedTokenTypeException$, UnsupportedTokenTypeException);
...
n0_registry5.registerError(UnsupportedUserStateException$, UnsupportedUserStateException);
...
n0_registry5.registerError(UserImportInProgressException$, UserImportInProgressException);
...
n0_registry5.registerError(UserLambdaValidationException$, UserLambdaValidationException);
...
n0_registry5.registerError(UsernameExistsException$, UsernameExistsException);
...
n0_registry5.registerError(UserNotConfirmedException$, UserNotConfirmedException);
...
n0_registry5.registerError(UserNotFoundException$, UserNotFoundException);
...
n0_registry5.registerError(UserPoolAddOnNotEnabledException$, UserPoolAddOnNotEnabledException);
...
n0_registry5.registerError(UserPoolTaggingException$, UserPoolTaggingException);
...
n0_registry5.registerError(WebAuthnChallengeNotFoundException$, WebAuthnChallengeNotFoundException);
...
n0_registry5.registerError(WebAuthnClientMismatchException$, WebAuthnClientMismatchException);
...
n0_registry5.registerError(WebAuthnConfigurationMissingException$, WebAuthnConfigurationMissingException);
...
n0_registry5.registerError(WebAuthnCredentialNotSupportedException$, WebAuthnCredentialNotSupportedException);
...
n0_registry5.registerError(WebAuthnNotEnabledException$, WebAuthnNotEnabledException);
...
n0_registry5.registerError(WebAuthnOriginNotAllowedException$, WebAuthnOriginNotAllowedException);
...
n0_registry5.registerError(WebAuthnRelyingPartyMismatchException$, WebAuthnRelyingPartyMismatchException);
var errorTypeRegistries5 = [
  _s_registry5,
  n0_registry5
];
var AttributeValueType = [0, n05, _AVT, 8, 0];
var ClientIdType = [0, n05, _CIT, 8, 0];
var ClientSecretType = [0, n05, _CST, 8, 0];
var PasswordType = [0, n05, _PT, 8, 0];
var SecretHashType = [0, n05, _SHT, 8, 0];
var SessionType = [0, n05, _ST2, 8, 0];
var TokenModelType = [0, n05, _TMT, 8, 0];
var UsernameType = [0, n05, _UT, 8, 0];
...
var AdminGetUserAuthFactorsResponse$ = [
  3,
  n05,
  _AGUAFRd,
  0,
...
var AdminGetUserResponse$ = [
  ...
  _AGURd,
  0,
  [_U, _UA, _UCD, _ULMD, _E2, _US, _MFAO, _PMS, _UMFASL],
...
var ConfirmForgotPasswordRequest$ = [
  ...
  _CFPR,
  0,
  [_CI, _U, _CC, _P2, _SH, _AM, _UCDs, _CM],
...
var CreateUserPoolClientRequest$ = [
  ...
  _CUPCR,
  0,
  [_UPI, _CNl, _GS, _CS2, _RTV, _ATV, _ITV, _TVU, _RAe, _WA, _EAF, _SIP, _CURL, _LURL, _DRURI, _AOAF, _AOAS, _AOAFUPC, _ACn, _PUEE, _ETR, _EPAUCD, _ASV, _RTR],
...
var GetClientTokenRequest$ = [
  3,
  n05,
  _GCTR,
  0,
  [_CI, _Sec, _Sc, _CM],
  [[() => ClientIdType, 0], [() => ClientSecretType, 0], 64 | 0, 128 | 0],
  2
];
...
var LambdaConfigType$ = [
  ...
  _LCT,
  0,
  [_PSU, _CMu, _PC2, _PA2, _PAo, _DAC, _CAC, _VACR, _PTG, _UM, _PTGC, _CSMSS, _CES, _KMSKID, _IF],
...
var SignUpRequest$ = [
  ...
  _SUR,
  0,
  [_CI, _U, _SH, _P2, _UA, _VD, _AM, _UCDs, _CM],
...
var SignUpResponse$ = [
  ...
  0,
  [_UCs, _USs, _CDD, _S],
  [2, 0, () => CodeDeliveryDetailsType$, [() => SessionType, 0]],
  2
];
...
var UserPoolClientType$ = [
  ...
  _UPCT,
  0,
  [_UPI, _CNl, _CI, _CS2, _LMD, _CDr, _RTV, _ATV, _ITV, _TVU, _RAe, _WA, _EAF, _SIP, _CURL, _LURL, _DRURI, _AOAF, _AOAS, _AOAFUPC, _ACn, _PUEE, _ETR, _EPAUCD, _ASV, _RTR],
...
// ../node_modules/@aws-sdk/client-cognito-identity-provider/dist-es/commandBuilder.js
init_client2();
init_endpoints();
var command5 = makeBuilder(commonParams, "AWSCognitoIdentityProviderService", "CognitoIdentityProviderClient", getEndpointPlugin);
var _ep05 = {};
...
var AdminConfirmSignUpCommand = class extends command5(_ep05, _mw05, "AdminConfirmSignUp", AdminConfirmSignUp$) {
};

// ../node_modules/@aws-sdk/client-cognito-identity-provider/dist-es/commands/InitiateAuthCommand.js
var InitiateAuthCommand = class extends command5(_ep05, _mw05, "InitiateAuth", InitiateAuth$) {
};

// ../node_modules/@aws-sdk/client-cognito-identity-provider/dist-es/commands/SignUpCommand.js
var SignUpCommand = class extends command5(_ep05, _mw05, "SignUp", SignUp$) {
};
...
var resolveHttpAuthSchemeConfig6 = (config) => {
  const config_0 = resolveAwsSdkSigV4Config(config);
  return Object.assign(config_0, {
    authSchemePreference: normalizeProvider(config.authSchemePreference ?? [])
  });
...
// ../node_modules/@aws-sdk/client-dynamodb/dist-es/commandBuilder.js
init_client2();
init_endpoints();
...
// ../node_modules/@aws-sdk/client-dynamodb/dist-es/commandBuilder.js
var command6 = makeBuilder(commonParams6, "DynamoDB_20120810", "DynamoDBClient", getEndpointPlugin);
var _ep06 = {};
var _ep2 = {
  ResourceArn: { type: "contextParams", name: "TableName" }
};
var _mw06 = (Command2, cs, config, o4) => [];
...
var _ECE2 = "ExportConflictException";
...
var _IEE2 = "InvalidEndpointException";
...
var _RNFE3 = "ReplicaNotFoundException";
...
var _r3 = "reason";
var _re = "resource";
var _s6 = "smithy.ts.sdk.synthetic.com.amazonaws.dynamodb";
var _se4 = "server";
var _tR = "throttlingReasons";
var _xacrsra = "x-amz-confirm-remove-self-resource-access";
var n06 = "com.amazonaws.dynamodb";
var _s_registry6 = TypeRegistry.for(_s6);
var DynamoDBServiceException$ = [-3, _s6, "DynamoDBServiceException", 0, [], []];
_s_registry6.registerError(DynamoDBServiceException$, DynamoDBServiceException);
var n0_registry6 = TypeRegistry.for(n06);
...
n0_registry6.registerError(BackupInUseException$, BackupInUseException);
...
n0_registry6.registerError(BackupNotFoundException$, BackupNotFoundException);
...
n0_registry6.registerError(ConditionalCheckFailedException$, ConditionalCheckFailedException);
...
n0_registry6.registerError(ContinuousBackupsUnavailableException$, ContinuousBackupsUnavailableException);
...
n0_registry6.registerError(DuplicateItemException$, DuplicateItemException);
...
n0_registry6.registerError(ExportConflictException$, ExportConflictException);
...
n0_registry6.registerError(ExportNotFoundException$, ExportNotFoundException);
...
n0_registry6.registerError(GlobalTableAlreadyExistsException$, GlobalTableAlreadyExistsException);
...
n0_registry6.registerError(GlobalTableNotFoundException$, GlobalTableNotFoundException);
...
n0_registry6.registerError(IdempotentParameterMismatchException$, IdempotentParameterMismatchException);
...
n0_registry6.registerError(ImportConflictException$, ImportConflictException);
...
n0_registry6.registerError(ImportNotFoundException$, ImportNotFoundException);
...
n0_registry6.registerError(IndexNotFoundException$, IndexNotFoundException);
...
n0_registry6.registerError(InternalServerError$, InternalServerError);
...
n0_registry6.registerError(InvalidEndpointException$, InvalidEndpointException);
...
n0_registry6.registerError(InvalidExportTimeException$, InvalidExportTimeException);
...
n0_registry6.registerError(InvalidRestoreTimeException$, InvalidRestoreTimeException);
...
n0_registry6.registerError(ItemCollectionSizeLimitExceededException$, ItemCollectionSizeLimitExceededException);
var LimitExceededException$2 = [
  -3,
  n06,
  _LEE2,
  { [_e6]: _c6 },
...
n0_registry6.registerError(LimitExceededException$2, LimitExceededException2);
...
n0_registry6.registerError(PointInTimeRecoveryUnavailableException$, PointInTimeRecoveryUnavailableException);
...
n0_registry6.registerError(PolicyNotFoundException$, PolicyNotFoundException);
...
n0_registry6.registerError(ProvisionedThroughputExceededException$, ProvisionedThroughputExceededException);
...
n0_registry6.registerError(ReplicaAlreadyExistsException$, ReplicaAlreadyExistsException);
...
n0_registry6.registerError(ReplicaNotFoundException$, ReplicaNotFoundException);
...
n0_registry6.registerError(ReplicatedWriteConflictException$, ReplicatedWriteConflictException);
...
n0_registry6.registerError(RequestLimitExceeded$, RequestLimitExceeded);
...
n0_registry6.registerError(ResourceInUseException$, ResourceInUseException);
var ResourceNotFoundException$3 = [
  -3,
  n06,
  _RNFEe,
  { [_e6]: _c6 },
...
n0_registry6.registerError(ResourceNotFoundException$3, ResourceNotFoundException3);
...
n0_registry6.registerError(TableAlreadyExistsException$, TableAlreadyExistsException);
...
n0_registry6.registerError(TableInUseException$, TableInUseException);
...
n0_registry6.registerError(TableNotFoundException$, TableNotFoundException);
...
n0_registry6.registerError(ThrottlingException$, ThrottlingException);
...
n0_registry6.registerError(TransactionCanceledException$, TransactionCanceledException);
...
n0_registry6.registerError(TransactionConflictException$, TransactionConflictException);
...
n0_registry6.registerError(TransactionInProgressException$, TransactionInProgressException);
var errorTypeRegistries6 = [
  _s_registry6,
  n0_registry6
];
...
var ConditionCheck$ = [
  ...
  _CCo,
  0,
  [_K2, _TN2, _CE, _EAN, _EAV, _RVOCCF],
...
var ConsumedCapacity$ = [
  ...
  _CC2,
  0,
  [_TN2, _CU, _RCU, _WCU, _T2, _LSI, _GSI, _VI],
...
var DeleteItemInput$ = [
  ...
  _DII,
  0,
  [_TN2, _K2, _Ex, _COo, _RV, _RCC, _RICM, _CE, _EAN, _EAV, _RVOCCF],
...
var DescribeContributorInsightsOutput$ = [
  ...
  _DCIO,
  0,
  [_TN2, _IN, _CIRL, _CISo, _LUDT, _FE2, _CIM],
...
var GetItemInput$ = [
  ...
  _GII,
  0,
  [_TN2, _K2, _ATG2, _CRo, _RCC, _PE, _EAN],
...
var PutItemInput$ = [
  ...
  _PII,
  0,
  [_TN2, _I, _Ex, _RV, _RCC, _RICM, _COo, _CE, _EAN, _EAV, _RVOCCF],
...
var QueryInput$ = [
  ...
  _QI,
  0,
  [_TN2, _IN, _Se, _ATG2, _L2, _CRo, _KC2, _QF, _COo, _SIF, _ESK, _RCC, _PE, _FEi, _KCE, _EAN, _EAV],
...
var ScanInput$ = [
  ...
  _SI2,
  0,
  [_TN2, _IN, _ATG2, _L2, _Se, _SF, _COo, _ESK, _RCC, _TSo, _Seg, _PE, _FEi, _EAN, _EAV, _CRo],
...
var SearchVectorsInput$ = [
  ...
  _SVI,
  0,
  [_TN2, _IN, _SV, _TK2, _RCC, _EAN, _EAV, _PE, _SCE],
...
var Update$ = [
  ...
  _U2,
  0,
  [_K2, _UE3, _TN2, _CE, _EAN, _EAV, _RVOCCF],
...
var UpdateItemInput$ = [
  ...
  _UII,
  0,
  [_TN2, _K2, _AU, _Ex, _COo, _RV, _RCC, _RICM, _UE3, _CE, _EAN, _EAV, _RVOCCF],
...
var DescribeEndpointsCommand = class extends command6(_ep06, _mw06, "DescribeEndpoints", DescribeEndpoints$) {
};
...
// ../node_modules/@aws-sdk/dynamodb-codec/dist-es/codec-v2/DynamoDBJsonCodec2.js
init_protocols2();
init_schema();
init_serde();
          ...
          this.writeAscii("[");
          {
            ...
            for (let i7 = 0; i7 < arr.length; i7++) {
              if (i7 > 0)
                this.writeAscii(",");
              if (arr[i7] != null) {
                this.writeAttributeValue(arr[i7]);
              } else {
        ...
        case "M":
          this.writeAscii("{");
          {
            ...
            for (const k7 in map) {
              ...
              this.writeJsonString(k7);
              this.writeAscii(":");
              this.writeAttributeValue(map[k7]);
            }
          }
          this.writeAscii("}");
          break;
...
var DynamoDBJsonShapeDeserializer2 = class extends JsonShapeDeserializer2 {
  ...
  readAttributeValue(av) {
    ...
    if (av.M && typeof av.M === "object") {
      const m5 = av.M;
      for (const k7 in m5) {
        m5[k7] = this.readAttributeValue(m5[k7]);
      }
    }
    return out;
  }
...
// ../node_modules/@aws-sdk/client-dynamodb/dist-es/endpoint/bdd.js
init_endpoints();
var L = "ref";
var M = "argv";
var a6 = -1;
...
var f6 = "PartitionResult";
var g6 = "stringEquals";
var h6 = "getAttr";
var i6 = "parsedEndpoint";
var j6 = "aws.parseArn";
var k6 = (n4) => "ParsedArn_ssa_" + n4;
var l4 = "service";
var m4 = "dynamodb";
...
var v = { [L]: "Region" };
var w = { [L]: f6 };
var x = { "fn": h6, [M]: [{ [L]: i6 }, "authority"] };
var y = { [L]: "AccountIdEndpointMode" };
var z = { "fn": h6, [M]: [w, "name"] };
var A = { "fn": h6, [M]: [{ [L]: "ParsedArn_ssa_2" }, "region"] };
var B = { [L]: "ParsedArn_ssa_2" };
var C = { [L]: "ResourceArnList" };
var D = { "fn": h6, [M]: [{ [L]: "ParsedArn_ssa_1" }, "region"] };
...
var _data6 = {
  conditions: [
    ...
    [d6, J],
    [e6, [{ [L]: "UseFIPS" }, b6]],
    [e6, [{ [L]: "UseDualStack" }, b6]],
    ["aws.partition", I, f6],
    [g6, [v, "local"]],
    [e6, [{ fn: h6, [M]: [w, "supportsFIPS"] }, b6]],
    ["parseURL", J, i6],
    [g6, ["dynamodb.{Region}.{PartitionResult#dualStackDnsSuffix}", x]],
    [e6, [{ fn: h6, [M]: [w, "supportsDualStack"] }, b6]],
    [g6, ["search-dynamodb.{Region}.{PartitionResult#dualStackDnsSuffix}", x]],
    [d6, [y]],
    [g6, [z, "aws"]],
    [g6, [y, "disabled"]],
    [d6, K2],
    ...
    [n3, [F, c6]],
    [g6, [z, "aws-us-gov"]],
    [e6, [{ fn: "coalesce", [M]: [{ [L]: "IsSearchOperation" }, c6] }, b6]]
  ],
  results: [
    [a6],
    ...
    [a6, "Endpoint override is not supported for dual-stack endpoints. Please enable dual-stack functionality by enabling the configuration. For more details, see: https://docs.aws.amazon.com/sdkref/latest/guide/feature-endpoints.html"],
    ["{Endpoint}", G],
    [a6, "Invalid Configuration: FIPS and local endpoint are not supported"],
    [a6, "Invalid Configuration: Dualstack and local endpoint are not supported"],
    ["http://localhost:8000", { authSchemes: [{ signingRegion: "us-east-1", name: "sigv4", signingName: m4 }] }],
    [a6, "Invalid Configuration: AccountIdEndpointMode is required and FIPS is enabled, but FIPS account endpoints are not supported"],
    ...
    [a6, "Credentials-sourced account ID parameter is invalid"],
    [a6, "AccountIdEndpointMode is required but no AccountID was provided or able to be loaded"],
    [a6, "Invalid Configuration: AccountIdEndpointMode is required but account endpoints are not supported in this partition"],
...
var bdd6 = BinaryDecisionDiagram.from(nodes6, root6, _data6.conditions, _data6.results);
...
var defaultEndpointResolver6 = (endpointParams, context = {}) => {
  return cache6.get(endpointParams, () => decideEndpoint(bdd6, {
    endpointParams,
    logger: context.logger
  }));
};
...
var resolveHttpAuthRuntimeConfig6 = (config) => {
  return {
    httpAuthSchemes: config.httpAuthSchemes(),
    httpAuthSchemeProvider: config.httpAuthSchemeProvider(),
    credentials: config.credentials()
...
// ../node_modules/@aws-sdk/client-dynamodb/dist-es/runtimeExtensions.js
var resolveRuntimeExtensions6 = (runtimeConfig, extensions) => {
  ...
  extensions.forEach((extension) => extension.configure(extensionConfiguration));
  return Object.assign(runtimeConfig, resolveAwsRegionExtensionConfiguration(extensionConfiguration), resolveDefaultRuntimeConfig2(extensionConfiguration), resolveHttpHandlerRuntimeConfig(extensionConfiguration), resolveHttpAuthRuntimeConfig6(extensionConfiguration));
};
...
var PutItemCommand = class extends command6(_ep2, _mw06, "PutItem", PutItem$) {
};

// ../node_modules/@aws-sdk/client-dynamodb/dist-es/commands/QueryCommand.js
var QueryCommand = class extends command6(_ep2, _mw06, "Query", Query$) {
};
  ...
  if (obj !== void 0) {
    if (keyNodes == null) {
      ...
      if (someChildren) {
        ...
        return Object.entries(obj ?? {}).reduce((acc, [k7, v2]) => {
          if (typeof v2 !== "function") {
            acc[k7] = processObj(v2, processFunc, keyNodes[NEXT_LEVEL]);
          }
          return acc;
        }, Array.isArray(obj) ? [] : {});
      }
...
var processKeysInObj = (obj, processFunc, keyNodes) => {
  ...
  if (Array.isArray(obj)) {
    ...
    accumulator = {};
    for (const [k7, v2] of Object.entries(obj)) {
      if (typeof v2 !== "function") {
        accumulator[k7] = v2;
      }
    }
  }
  for (const [nodeKey, nodes7] of Object.entries(keyNodes)) {
    if (typeof obj[nodeKey] === "function") {
      continue;
    }
    const processedValue = processObj(obj[nodeKey], processFunc, nodes7);
...
var DynamoDBDocumentClient = class _DynamoDBDocumentClient extends Client {
  ...
  constructor(client2, translateConfig) {
    ...
    const hasSerializer = middlewares.some((m5) => m5.includes?.("serializerMiddleware"));
    if (!hasSerializer) {
      ...
      const substituteClientHasSerializer = substituteClient.middlewareStack.identify?.().some((m5) => m5.includes?.("serializerMiddleware"));
...
var TABLE_NAME = process.env.TABLE_NAME || "DisasterLink";
var putItem = async (item) => {
  const command7 = new PutCommand({
    TableName: TABLE_NAME,
    Item: item
  });
  return docClient.send(command7);
};

// handlers/incidents/index.js
var cognitoClient = new CognitoIdentityProviderClient({ region: process.env.AWS_REGION || "ap-south-1" });
