    ...
    try {
        ...
        if (httpMethod === 'POST' && path === '/auth/register') {
            ...
            const dbItem = {
                ...
                skills: data.skills || [],
                // Default Kathmandu coords so distance-based matching works out of the box
                lat: parseFloat(data.lat) || 27.7172,
                lng: parseFloat(data.lng) || 85.324,
                // Defaults used by VolunteerManagement UI
                status: "Available",
