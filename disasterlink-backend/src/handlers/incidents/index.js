...
// Fields allowed to be updated on an incident via PUT /incidents/{id}
...
// Fields allowed to be updated on a response update via PUT /incidents/updates/{id}
const UPDATE_UPDATABLE_FIELDS = [
    "title",
    "description",
    "status",
    "severity",
...
export const handler = async (event) => {
    ...
    try {
        // ============================================================
        // 1. GET /incidents/updates  (sub-path MUST be checked before base /incidents)
        // ============================================================
        ...
        // ============================================================
        // 3. PUT /incidents/updates/{id}  — DYNAMIC UPDATE (fixed: returns full item)
        // ============================================================
        if (path.startsWith("/incidents/updates/") && method === "PUT") {
            ...
            UPDATE_UPDATABLE_FIELDS.forEach((field, i) => {
        ...
        // ============================================================
        // 5. POST /incidents/upload-url  (S3 presigned URL)
        // ============================================================
        ...
        // ============================================================
        // 7. POST /incidents  (Smart Priority Scoring + Geocoding + SNS)
        // ============================================================
        ...
        // ============================================================
        // 8. PUT /incidents/{id}  — DYNAMIC UPDATE (returns full item)
        // ============================================================
        if (path.startsWith("/incidents/") && method === "PUT") {
            ...
            INCIDENT_UPDATABLE_FIELDS.forEach((field, i) => {
                if (body[field] !== undefined) {
                    updates.push(`#f${i} = :v${i}`);
                    names[`#f${i}`] = field;
                    values[`:v${i}`] = body[field];
