                        ...
                        <div className="flex items-start justify-between border-b border-gray-100 bg-[#f5f7fb] p-5">
                            <div>
                                <div className="mb-2 flex items-center gap-2">
                                    ...
                                    <span className={`rounded-full px-3 py-1 text-[10px] font-bold text-white ${currentIncident.severity === "CRITICAL" || currentIncident.severity === "Critical"
                                            ? "bg-[#FF5252]"
                                            : "bg-[#FF9800]"
                                        }`}>
                        ...
                        <div className="flex-1 space-y-6 overflow-y-auto p-5">
                            ...
                            <div>
                                ...
                                <VolunteerMatching
                                    ...
                                    limit={5}
                                    onAssigned={() => {
                                        const fresh = incidents.find((i) => i.id === currentIncident.id);
