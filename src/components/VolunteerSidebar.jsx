    ...
    return (
        <aside className="fixed left-0 top-0 z-50 flex h-screen w-[280px] flex-col bg-[#192640] text-white">
            ...
            <div className="px-5 pb-6">
                ...
                <button
                    className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#4CAF50] px-4 py-3 font-semibold transition hover:bg-[#43a047]"
                >
